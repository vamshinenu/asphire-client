        ...
        <>
            ...
            >
                <input
                    ...
                    disabled={sending}
                    className={`w-full px-3 py-2 text-lg rounded-xl border-zinc-500 bg-zinc-200 placeholder-zinc-300 disabled:text-zinc-700`}
                    onChange={
                ...
                />
                {
                    sending && (
                        <svg
                            aria-hidden="true"
                            role="status"
                            className="inline w-10 h-10 mr-3 text-emerald-400 animate-spin"
                            viewBox="0 0 100 101"
                            fill="none"
...

            {
                error && (
                    <div className='fixed flex flex-row items-center justify-center gap-2 px-4 py-2 mx-10 text-red-500 duration-500 shadow-lg bg-zinc-50 bottom-10 animate-bounce rounded-3xl'>
                        <p className='text-xs text-center'>Unable to send message at the moment</p>
                        <button className='px-4 py-2 font-bold text-center text-white bg-black rounded-full' onClick={() => setError(false)}>
                            <X
                                height={20}
                                width={20}
                            />
            ...
            {/* {
                sent && (
                    <div className='fixed flex flex-row items-center justify-center gap-2 px-4 py-2 mx-10 text-green-500 duration-500 shadow-lg bg-zinc-50 bottom-10 animate-bounce rounded-3xl'>
                        <p className='text-xs text-center'> Message Sent</p>
                        <button className='px-4 py-2 font-bold text-center text-white bg-black rounded-full' onClick={() => setSent(false)}>
                            <X
                                height={20}
                                width={20}
                            />
